...
import com.jstech.gridregulation.bean.RegulateObject;
...
public class SiteInspectionObjectMapActivity extends BaseActivity implements SensorEventListener, BaiduMap.OnMarkerClickListener {
    ...
    ArrayList<RegulateObject> mRegulateObjectArrayList = new ArrayList<>();//监管对象list
    ...
    private void initList() {
        ...
        for (int i = 0; i < 4; i++) {
            RegulateObject object = new RegulateObject();
            object.setName("企业" + i);
    ...
    public boolean onMarkerClick(Marker marker) {
        for (RegulateObject o : mRegulateObjectArrayList) {
